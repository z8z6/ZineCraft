...
| `victoria_battle_scarred_armor` | `bg_giantwall_27g4/27g5`   | 小口径弹孔、擦痕与局部锈蚀   | 已实现；原创战损纹理，仅少量穿插     |
| `victoria_blast_scarred_armor`  | `bg_giantwall_27g4/27g5`   | 爆心暗坑、热蚀环与放射裂痕   | 已实现；原创战损纹理，用于破口和弹坑边缘 |
...
的工业铁块、金属梁、传动轴、齿轮箱、离合器、飞轮、转速表、应力表、流体管道与机械泵用于后膛、火控和维修区；门窗、灯具、铁栏、楼梯、家具与容器可继续使用原版方块。

战损块不得大面积平铺：弹痕装甲用于稀疏替换完整外板，爆蚀装甲只围绕确定性的破口、屋顶弹坑和残缺胸墙布置，且不破坏跨模块主通道。

国别标识使用原版红色墙旗的分层图案：黑色边框、金色菱盾、黑色圆心与金色顶三角，表达维多利亚官方图标的盾冠式纹章气质。该图案为结构内原创体素转译，不直接复制、描摹或发布官方图标；室内挂旗必须贴附完整墙面，屋顶旗帜必须贴附结构框架。
