...
/**
 * 在 JourneyMap 中显示统一计算的 Nation、City、Region 三级 Voronoi 边界。
 */
...
public final class ZinecraftJourneyMapPlugin implements IClientPlugin {
  ...
  private static void showRegionBorders(IClientAPI api, TerraLayoutPlan plan) {
    ...
    Zinecraft.LOGGER.info("已向 JourneyMap 注册 {} 个泰拉城区边界", shown);
  }
  ...
  private static ShapeProperties shape(int color, float strokeWidth, float fillOpacity) {
