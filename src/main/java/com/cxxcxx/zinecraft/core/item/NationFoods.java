...
public final class NationFoods {
  ...
  @NotNull
  private static final ItemEntry<Item> AEGIR_FRESH_SHELLCRAB_SASHIMI = foodWithDefaults(
      INSTANCE, "aegir_fresh_shellcrab_sashimi", "阿戈尔鲜切蟹生", "Aegir Fresh-Cut Shellcrab Sashimi", 6, 0.7F, false, false, 96, null
  );
  @NotNull
  private static final ItemEntry<Item> BOLIVAR_SMOKED_CAPSULE = foodWithDefaults(
      INSTANCE, "bolivar_smoked_capsule", "玻利瓦尔熏烤胶囊", "Bolivar Smoked Capsule", 7, 0.8F, true, false, 64, null
  );
  @NotNull
  private static final ItemEntry<Item> HIGASHI_NANO_KAPPO = foodWithDefaults(
      INSTANCE, "higashi_nano_kappo", "东国纳米割烹", "Higashi Nano Kappo", 8, 0.9F, false, false, 96, null
  );
  @NotNull
  private static final ItemEntry<Item> DURIN_HONEY_SLUGPUDDING = foodWithDefaults(
      INSTANCE, "durin_honey_slugpudding", "杜林蜜味源石虫布丁", "Durin Honey Slugpudding", 5, 0.6F, true, false, 64, null
  );
  @NotNull
  private static final ItemEntry<Item> COLUMBIA_ORIGINIUM_ROASTED_FOWL = foodWithDefaults(
