...
public final class SanktaFormalResidentEntity extends PathfinderMob {
  ...
  public static boolean canSpawn(
      EntityType<SanktaFormalResidentEntity> type,
    ...
    boolean lateranoSurface = surface.is(ModBlock.LATERANO_ALLUVIAL_CHALK.get())
        || surface.is(Blocks.GRASS_BLOCK);
    return lateranoSurface && Mob.checkMobSpawnRules(type, level, spawnType, pos, random);
  }
