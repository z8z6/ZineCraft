...
public final class ModSurfaceRule {
  ...
  private static final List<SurfaceDefinition> SURFACES = List.of(
      ...
      solid(ModBiome.AEGIR_PELAGIC_DEPTHS.key(), ModBlock.AEGIR_ABYSSAL_SLATE),
      solid(ModBiome.AEGIR_CITY.key(), ModBlock.AEGIR_ABYSSAL_SLATE),
      ecological(ModBiome.BOLIVAR_PLAIN.key(), ModBlock.BOLIVAR_WAR_SCOURED_SOIL),
      ecological(ModBiome.BOLIVAR_BLACKFLOW_FOREST.key(), ModBlock.BOLIVAR_WAR_SCOURED_SOIL),
      ecological(ModBiome.BOLIVAR_CITY.key(), ModBlock.BOLIVAR_WAR_SCOURED_SOIL),
      ecological(ModBiome.HIGASHI_SHADOW_RIFT.key(), ModBlock.HIGASHI_SHADOW_LOAM),
      ecological(ModBiome.HIGASHI_MOUNTAIN_FOREST.key(), ModBlock.HIGASHI_SHADOW_LOAM),
      ecological(ModBiome.HIGASHI_CITY.key(), ModBlock.HIGASHI_SHADOW_LOAM),
      solid(ModBiome.DURIN_UNDERGROUND_GARDEN.key(), ModBlock.DURIN_GARDEN_MOSS),
      solid(ModBiome.DURIN_CAVERN_LAKE.key(), ModBlock.DURIN_GARDEN_MOSS),
      solid(ModBiome.DURIN_CITY.key(), ModBlock.DURIN_GARDEN_MOSS),
      ecological(ModBiome.COLUMBIA_SANDSTONE_WILDS.key(), ModBlock.COLUMBIA_CANYON_SOIL),
      ecological(ModBiome.COLUMBIA_EASTERN_PRAIRIE.key(), ModBlock.COLUMBIA_CANYON_SOIL),
      ecological(ModBiome.COLUMBIA_CITY.key(), ModBlock.COLUMBIA_CANYON_SOIL),
      solid(ModBiome.KAZIMIERZ_KNIGHTLAND.key(), ModBlock.KAZIMIERZ_STEPPE_TURF),
      solid(ModBiome.KAZIMIERZ_FORESTED_HILLS.key(), ModBlock.KAZIMIERZ_STEPPE_TURF),
      solid(ModBiome.KAZIMIERZ_CITY.key(), ModBlock.KAZIMIERZ_STEPPE_TURF),
      solid(ModBiome.KAZDEL_SCARRED_WASTES.key(), ModBlock.KAZDEL_SCARRED_ASH),
      solid(ModBiome.KAZDEL_RUINED_HIGHLANDS.key(), ModBlock.KAZDEL_SCARRED_ASH),
      solid(ModBiome.KAZDEL_CITY.key(), ModBlock.KAZDEL_SCARRED_ASH),
      ecological(ModBiome.LATERANO_HOLY_FIELDS.key(), ModBlock.LATERANO_ALLUVIAL_CHALK),
      ecological(ModBiome.LATERANO_HIGHLAND_PLATEAU.key(), ModBlock.LATERANO_ALLUVIAL_CHALK),
      ecological(ModBiome.LATERANO_CITY.key(), ModBlock.LATERANO_ALLUVIAL_CHALK),
      ecological(ModBiome.LEITHANIEN_TWILIGHT_FOREST.key(), ModBlock.LEITHANIEN_TWILIGHT_HUMUS),
      ecological(ModBiome.LEITHANIEN_ALPINE_VALLEY.key(), ModBlock.LEITHANIEN_TWILIGHT_HUMUS),
      ecological(ModBiome.LEITHANIEN_CITY.key(), ModBlock.LEITHANIEN_TWILIGHT_HUMUS),
      solid(ModBiome.RIM_BILLITON_MINING_BADLANDS.key(), ModBlock.RIM_BILLITON_MINE_TAILINGS),
      solid(ModBiome.RIM_BILLITON_ARID_MESA.key(), ModBlock.RIM_BILLITON_MINE_TAILINGS),
      solid(ModBiome.RIM_BILLITON_CITY.key(), ModBlock.RIM_BILLITON_MINE_TAILINGS),
      ecological(ModBiome.MINOS_SUNLIT_HILLS.key(), ModBlock.MINOS_SUNBAKED_EARTH),
      ecological(ModBiome.MINOS_RIVER_VALLEY.key(), ModBlock.MINOS_SUNBAKED_EARTH),
      ecological(ModBiome.MINOS_CITY.key(), ModBlock.MINOS_SUNBAKED_EARTH),
      solid(ModBiome.SARGON_ROCKY_DESERT.key(), ModBlock.SARGON_DESERT_CRUST),
      ecological(ModBiome.SARGON_TROPICAL_RAINFOREST.key(), ModBlock.SARGON_DESERT_CRUST),
      solid(ModBiome.SARGON_CITY.key(), ModBlock.SARGON_DESERT_CRUST),
      solid(ModBiome.SAMI_FROZEN_FOREST.key(), ModBlock.SAMI_FROST_MOSS),
      solid(ModBiome.SAMI_GLACIAL_MOUNTAINS.key(), ModBlock.SAMI_FROST_MOSS),
      solid(ModBiome.SAMI_CITY.key(), ModBlock.SAMI_FROST_MOSS),
      ecological(ModBiome.VICTORIA_MISTY_HIGHLANDS.key(), ModBlock.VICTORIA_MOORLAND_SOIL),
      ecological(ModBiome.VICTORIA_CENTRAL_LOWLANDS.key(), ModBlock.VICTORIA_MOORLAND_SOIL),
      ecological(ModBiome.VICTORIA_CITY.key(), ModBlock.VICTORIA_MOORLAND_SOIL),
      solid(ModBiome.URSUS_FROZEN_STEPPE.key(), ModBlock.URSUS_PERMAFROST),
      solid(ModBiome.URSUS_EASTERN_HIGHLANDS.key(), ModBlock.URSUS_PERMAFROST),
      solid(ModBiome.URSUS_CITY.key(), ModBlock.URSUS_PERMAFROST),
      solid(ModBiome.KJERAG_SNOWY_PEAKS.key(), ModBlock.KJERAG_SACRED_SNOWSTONE),
      solid(ModBiome.KJERAG_ALPINE_FOREST.key(), ModBlock.KJERAG_SACRED_SNOWSTONE),
      solid(ModBiome.KJERAG_CITY.key(), ModBlock.KJERAG_SACRED_SNOWSTONE),
      ecological(ModBiome.SIRACUSA_RAINY_WOODLAND.key(), ModBlock.SIRACUSA_RAIN_DARKENED_SOIL),
      ecological(ModBiome.SIRACUSA_LOWLAND_FOREST.key(), ModBlock.SIRACUSA_RAIN_DARKENED_SOIL),
      ecological(ModBiome.SIRACUSA_CITY.key(), ModBlock.SIRACUSA_RAIN_DARKENED_SOIL),
      ...
      ecological(ModBiome.YAN_CITY.key(), ModBlock.YAN_MOUNTAIN_SOIL),
      ...
      solid(ModBiome.IBERIA_CITY.key(), ModBlock.IBERIA_SALT_CRUSTED_GRAVEL)
  );
