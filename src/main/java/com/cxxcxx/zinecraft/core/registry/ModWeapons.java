...
public final class ModWeapons {
  ...
  public static final DeferredItem<Item> TEST_CARTRIDGE = new ItemBuilder<>(
      ...
      .build()
      .getItem();
  public static final DeferredItem<FirearmItem> TEST_RIFLE_ITEM = new ItemBuilder<>(
      Zinecraft.ITEMS, "test_rifle", "测试步枪", "Test Rifle", ModWeapons::createTestRifle,
          vanillaModel("crossbow"), true)
      .build()
      .getItem();
  public static final DeferredItem<ActionWeaponItem> TEST_STAFF_ITEM = new ItemBuilder<>(
      Zinecraft.ITEMS, "test_staff", "测试法杖", "Test Staff", ModWeapons::createTestStaff,
          vanillaModel("blaze_rod"), true)
      .build()
      .getItem();
  private static final ModelTemplate VANILLA_IRON_SWORD_MODEL = vanillaModel("iron_sword");
  public static final DeferredItem<SwordItem> TEST_SWORD_ITEM = new ItemBuilder<>(
      Zinecraft.ITEMS, "test_sword", "测试剑", "Test Sword", ModWeapons::createTestSword,
