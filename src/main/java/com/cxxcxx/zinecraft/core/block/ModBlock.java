...
public final class ModBlock {
  ...
  public static final BlockBuilder<Block> STARGATE_ARCH = Zinecraft.BLOCKS.builder(
          "stargate_arch", "星门拱石",
  ...
  public static final BlockBuilder<StarGateControllerBlock> STARGATE_CONTROLLER = Zinecraft.BLOCKS.builder(
  ...
  public static final BlockBuilder<StarGatePortalBlock> STARGATE_PORTAL = Zinecraft.BLOCKS.builder(
  ...
  public static final BlockBuilder<ExampleEntityBlock> EXAMPLE_ENTITY_BLOCK = Zinecraft.BLOCKS.builder(
  ...
  private static MessageBuilder message(String path, String zhCn, String enUs) {
    return Zinecraft.TRANSLATIONS.message("message." + Zinecraft.MOD_ID + "." + path, zhCn, enUs);
  }
