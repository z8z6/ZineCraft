...
public final class NationBlocks {
  ...
  @NotNull
  private static final Block AEGIR_ABYSSAL_SLATE;
  @NotNull
  private static final Block AEGIR_PRESSURE_TILE;
  @NotNull
  private static final Block BOLIVAR_WAR_SCOURED_SOIL;
  @NotNull
  private static final Block BOLIVAR_DOSSOLES_STUCCO;
  @NotNull
  private static final Block HIGASHI_SHADOW_LOAM;
  @NotNull
  private static final Block HIGASHI_MACHIYA_PLASTER;
  @NotNull
  private static final Block DURIN_GARDEN_MOSS;
  @NotNull
  private static final Block DURIN_IDEAL_CITY_PANEL;
  @NotNull
  private static final Block COLUMBIA_CANYON_SOIL;
  @NotNull
  private static final Block COLUMBIA_FRONTIER_PANEL;
  @NotNull
  private static final Block KAZIMIERZ_STEPPE_TURF;
  @NotNull
  private static final Block KAZIMIERZ_ARENA_MASONRY;
  @NotNull
  private static final Block KAZDEL_SCARRED_ASH;
  @NotNull
  private static final Block KAZDEL_FORTRESS_PLATE;
  @NotNull
  private static final Block LATERANO_ALLUVIAL_CHALK;
  @NotNull
  private static final Block LATERANO_BASILICA_MARBLE;
  @NotNull
  private static final Block LATERANO_HOST_CASING;
  @NotNull
  private static final Block LATERANO_HOST_CONDUIT;
  @NotNull
  private static final Block LEITHANIEN_TWILIGHT_HUMUS;
  @NotNull
  private static final Block LEITHANIEN_RESONANT_BRICK;
  @NotNull
  private static final Block RIM_BILLITON_MINE_TAILINGS;
  @NotNull
  private static final Block RIM_BILLITON_CORRUGATED_STEEL;
  @NotNull
  private static final Block MINOS_SUNBAKED_EARTH;
  @NotNull
  private static final Block MINOS_HEROIC_MASONRY;
  @NotNull
  private static final Block SARGON_DESERT_CRUST;
  @NotNull
  private static final Block SARGON_OASIS_ADOBE;
  @NotNull
  private static final Block SAMI_FROST_MOSS;
  @NotNull
  private static final Block SAMI_RITUAL_STONE;
  @NotNull
  private static final Block VICTORIA_MOORLAND_SOIL;
  @NotNull
  private static final Block VICTORIA_INDUSTRIAL_BRICK;
  @NotNull
  private static final Block URSUS_PERMAFROST;
  @NotNull
  private static final Block URSUS_IMPERIAL_MASONRY;
  @NotNull
  private static final Block KJERAG_SACRED_SNOWSTONE;
  @NotNull
  private static final Block KJERAG_MONASTERY_STONE;
  @NotNull
  private static final Block SIRACUSA_RAIN_DARKENED_SOIL;
  @NotNull
  private static final Block SIRACUSA_FAMILY_MASONRY;
  @NotNull
  private static final Block YAN_MOUNTAIN_SOIL;
  @NotNull
  private static final Block YAN_COURTYARD_BRICK;
  @NotNull
  private static final Block IBERIA_SALT_CRUSTED_GRAVEL;
  @NotNull
  private static final Block IBERIA_COASTAL_MASONRY;
