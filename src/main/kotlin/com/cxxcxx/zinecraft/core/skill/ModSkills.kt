...
/** 首批覆盖八职业的明日方舟代表技能；数值采用 PRTS 所列专精三数据。 */
object ModSkills {
  val SUPPORT_BETA = Zinecraft.SKILLS.register(
    "skill_support_beta", "支援号令·β型", "Support β",
    "桃金娘", "Myrtle", SkillProfession.VANGUARD,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    13, 22, 8,
  ...
  val TRUESILVER_SLASH = Zinecraft.SKILLS.register(
    "skill_truesilver_slash", "真银斩", "Truesilver Slash",
    "银灰", "SilverAsh", SkillProfession.GUARD,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    75, 90, 30,
  ...
  val OVERLOADING_MODE = Zinecraft.SKILLS.register(
    "skill_overloading_mode", "过载模式", "Overloading Mode",
    "能天使", "Exusiai", SkillProfession.SNIPER,
    "自动回复", "Auto Recovery", "自动触发", "Auto Trigger",
    20, 30, 15,
    "自动开启，攻击变为五连射并缩短攻击间隔。",
  ...
  val VOLCANO = Zinecraft.SKILLS.register(
    "skill_volcano", "火山", "Volcano",
    "艾雅法拉", "Eyjafjalla", SkillProfession.CASTER,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    55, 80, 15,
  ...
  val CALCIFICATION = Zinecraft.SKILLS.register(
    "skill_calcification", "钙质化", "Calcification",
    "塞雷娅", "Saria", SkillProfession.DEFENDER,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    70, 80, 30,
  ...
  val SANCTUARY = Zinecraft.SKILLS.register(
    "skill_sanctuary", "圣域", "Sanctuary",
    "夜莺", "Nightingale", SkillProfession.MEDIC,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    115, 120, 60,
  ...
  val FOXFIRE_HAZE = Zinecraft.SKILLS.register(
    "skill_foxfire_haze", "狐火渺然", "Foxfire Haze",
    "铃兰", "Suzuran", SkillProfession.SUPPORTER,
    "自动回复", "Auto Recovery", "手动触发", "Manual",
    50, 70, 35,
  ...
  val WOLFPACK = Zinecraft.SKILLS.register(
    "skill_wolfpack", "狼群", "Wolfpack",
    "红", "Projekt Red", SkillProfession.SPECIALIST,
    "被动", "Passive", "部署触发", "On Deployment",
    0, 0, null,
