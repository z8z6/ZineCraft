...
class ModModelProvider(output: FabricDataOutput) : FabricModelProvider(output) {
  ...
  override fun generateItemModels(itemModelGenerator: ItemModelGenerators?) {
    ...
    itemModelGenerator?.generateFlatItem(ModItem.ORIROCK, ModelTemplates.FLAT_ITEM)
    ...
    itemModelGenerator?.generateFlatItem(ModItem.POLYESTER_GROUP, ModelTemplates.FLAT_ITEM)
    ...
    itemModelGenerator?.generateFlatItem(ModItem.REFINED_SOLVENT, ModelTemplates.FLAT_ITEM)
    ...
    itemModelGenerator?.generateFlatItem(ModItem.ORIRON_GROUP, ModelTemplates.FLAT_ITEM)
    ...
    itemModelGenerator?.generateFlatItem(ModItem.POLYMER_AGENT, ModelTemplates.FLAT_ITEM)
    ...
    itemModelGenerator?.generateFlatItem(ModItem.CHIP_VANGUARD, ModelTemplates.FLAT_ITEM)
    itemModelGenerator?.generateFlatItem(ModItem.CHIP_VANGUARD_GROUP, ModelTemplates.FLAT_ITEM)
